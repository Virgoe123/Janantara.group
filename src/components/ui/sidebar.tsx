      ...
      >
        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset" ? "group-data-[state=collapsed]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4))]"
              : ""
          )}
        />
        ...
        <div
          className={cn(
            ...
            side === "left"
              ? "left-0 group-data-[state=collapsed]:group-data-[collapsible=offcanvas]:-left-full"
              : "right-0 group-data-[state=collapsed]:group-data-[collapsible=offcanvas]:-right-full",
  ...
  "peer/menu-button flex w-full items-center gap-3 overflow-hidden rounded-md px-3 text-left outline-none ring-sidebar-ring transition-all hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-semibold data-[active=true]:text-sidebar-accent-foreground data-[state=open]:bg-sidebar-accent data-[state=open]:text-sidebar-accent-foreground group-data-[state=collapsed]:group-data-[collapsible=icon]:justify-center group-data-[state=collapsed]:group-data-[collapsible=icon]:px-0 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      ...
      size: {
        default: "h-9 text-sm",
        sm: "h-8 text-xs",
        lg: "h-11 text-base group-data-[state=collapsed]:group-data-[collapsible=icon]:size-11",
      },
    },
    defaultVariants: {
      variant: "default",
