...
export function Hero() {
  return (
    <section className="relative w-full overflow-hidden">
      ...
      <GradientOrb className="h-64 w-64 top-1/4 left-1/4 animate-float" style={{ animationDelay: '0s' }} />
      <GradientOrb className="h-72 w-72 top-1/2 right-1/4 animate-float" style={{ animationDelay: '2s' }} />
      <GradientOrb className="hidden md:block h-48 w-48 bottom-10 left-20 animate-float" style={{ animationDelay: '4s' }} />
      <GradientOrb className="hidden md:block h-56 w-56 top-0 -right-20 animate-float" style={{ animationDelay: '1s' }} />
