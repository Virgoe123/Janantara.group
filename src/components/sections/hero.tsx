...
export function Hero() {
  return (
    <section id="home" className="relative w-full h-screen min-h-[700px] flex flex-col justify-center overflow-hidden bg-[hsl(150,56%,95%)]">
      <div className="absolute inset-0 vertical-lines" />
       <div className="absolute inset-0 bg-background/20 backdrop-blur-sm" />

      <div className="relative container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center space-y-6 text-center">
          <Badge variant="outline" className="bg-background/20 border-primary/50 text-primary py-1 px-3">
      ...
      <div className="absolute bottom-0 w-full p-8">
        <div className="container mx-auto px-4 md:px-6 flex items-center justify-between text-sm font-medium text-muted-foreground">
